// Thin re-export barrel — all screens live in ./admin/*.tsx
export { SWITCH_ACCOUNTS } from "./admin/shell";
...
export { AdminNotifsScreen } from "./admin/notifications";
export { AdminLoginScreen, AdminRoleConfirmScreen, AdminProfileScreen } from "./admin/login";
