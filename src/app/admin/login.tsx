          ...
          <AnimatePresence mode="wait">
            ...
            {phase !== "success" && (
              <motion.form key="form" onSubmit={handleSubmit} noValidate
                ...
                <button type="button"
                  className="w-full flex items-center justify-center gap-2.5 py-[10px] rounded-[6px] text-[12px] border border-[#DCD4C2] bg-[#FCFAF3] text-[#1E1B16] hover:bg-[#F6F1E7] transition-colors"
                  style={{ fontFamily:"'Public Sans',system-ui,sans-serif" }}>
